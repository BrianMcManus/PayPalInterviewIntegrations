<%-- 
    Document   : links
    Created on : 29-Nov-2017, 18:37:02
    Author     : brian
--%>
...
<html>
    ...
    <body>
        ...
        <h1 style="margin-top: 7%">Links to integrations</h1>
        
         <a href='index.jsp' class="thumbnail">Braintree Drop-in UI</a>
         <a href='merchantTransactions.jsp' class="thumbnail">View Merchant Transactions</a>
